...
(async function () {
	...
	model = await tf.loadModel('https://cmpe-258-project.s3.amazonaws.com/model.json');
	$("#selected-image").attr("src", "https://cmpe-258-final-project.s3.amazonaws.com/assets/alt_icon.jpg");
